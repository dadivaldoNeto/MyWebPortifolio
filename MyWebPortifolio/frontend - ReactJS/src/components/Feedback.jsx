...
const Feedback = () => {
  ...
  bagos: "bolinhas",
  cabaço: "novato",
  caralha: "sorvetão", // Variação de caralho
  chana: "florzona", // Variação de buceta
  kacete: "biscoitão", // Variação de cacete
  mandioca: "cenourinha",
  pica: "gravetão",
  pintelho: "peninha",
  rabo: "caudinha",
  trepar: "dançar",
  xana: "borboletinha", // Variação de xoxota
  ...
  cuzona: "docinho gigante", // Variação de cuzão
  débil: "pensador",
  escroto: "joia rara",
  fedido: "aromático",
  fuleco: "artista",
