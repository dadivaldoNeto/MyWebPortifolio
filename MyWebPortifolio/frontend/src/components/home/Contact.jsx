    ...
    <section className="contact" id="contact">
      ...
      <div className="contact-links">
        <a href="mailto:brunofragaa97@gmail.com">
          ...
          Email: brunofragaa97@gmail.com
        </a>
        <a href="https://www.linkedin.com/in/bruno-fraga-dev/" target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M4 4h16v16H4V4zm4 14h2v-6H8v6zm1-7a1 1 0 100-2 1 1 0 000 2zm4 7h2v-3c0-1 0-3-2-3s-2 2-2 3v3z"/>
          </svg>
          LinkedIn: linkedin.com/in/bruno-fraga-dev/
        </a>
      </div>
    </section>
  );
